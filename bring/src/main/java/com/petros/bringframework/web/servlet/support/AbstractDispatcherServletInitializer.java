...
import com.petros.bringframework.web.context.ContextLoaderListener;
...
import com.petros.bringframework.web.servlet.DispatcherServlet;
...
public abstract class AbstractDispatcherServletInitializer implements WebAppInitializer {
    ...
    protected WebAppContext createServletApplicationContext() {
        return new ServletAnnotationConfigApplicationContext();
    }
    ...
    /**
     * Create a {@link DispatcherServlet} (or other kind of {@link BasicFrameworkServlet}-derived
